...
class CalculationsMixinParallel:
    ...
    def _calculate_mutual_information_diagonal(self, Deltas, base):
        ...
        for i, ts in ProgressBar(enumerate(range(start, stop)), desc=f'calculating mutual information...'):
        ...
        self._mutual_information = global_mi
