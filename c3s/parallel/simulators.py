...
from .calculations import CalculationsMixinParallel
from ..utils import split_tasks_for_workers, timeit, ProgressBar
...
class ChemicalMasterEquation(SimulatorBase, CalculationsMixinParallel):
